...
# MAGIC
# MAGIC #### PLEASE READ: This notebook will set up your lab environment for the remainder of this course. Running this notebooks is REQUIRED. If you do not run this notebook in your lab you will not have the necessary data and catalogs to complete the rest of this course.
# MAGIC
# MAGIC
...
# MAGIC %md
# MAGIC 6. Delete the tables we creating during our initial development to clean up our catalog.
