...
# MAGIC     ```
# MAGIC
# MAGIC 3. At the top right of the file, next to the file name **README.md**, you’ll see your repo branch name, **main**.
# MAGIC
...
# MAGIC %md
# MAGIC ## G. Pull within Databricks
