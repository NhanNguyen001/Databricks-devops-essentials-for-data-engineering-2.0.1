...
# MAGIC
# MAGIC     e. After reviewing the file, close the tab.
# MAGIC
...
# MAGIC %md
# MAGIC 5.  In the next cell use `pytest` to execute all the tests (3 tests) within the **tests/unit_tests/test_spark_helper_functions.py** file.
# MAGIC
...
# MAGIC %md
# MAGIC 6. View the output of the cell above. Notice that:
# MAGIC
...
# MAGIC - [chispas](https://github.com/MrPowers/chispa)
