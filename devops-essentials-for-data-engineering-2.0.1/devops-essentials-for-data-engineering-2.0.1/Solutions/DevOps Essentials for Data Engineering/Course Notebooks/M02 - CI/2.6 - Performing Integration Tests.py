...
# MAGIC
# MAGIC    a. In the far left navigation pane, right-click on **Delta Live Tables** and select *Open in a New Tab*.
# MAGIC
...
# MAGIC
# MAGIC    d. At the top of the Delta Live Tables UI select the kebab menu (three ellipses) and select **View settings YAML**. Notice that the UI provides the necessary YAML files for future deployment. We will talk more about this this later. 
# MAGIC
