...
# MAGIC
# MAGIC     - `convert_miles_to_km`: Converts a column from miles to kilometers.
# MAGIC
...
## convert_miles_to_km
def convert_milles_to_km(df, new_column_name, miles_column):
...
## Convert miles to km
df = convert_milles_to_km(df, new_column_name = "trip_distance_km", miles_column = "trip_distance")
